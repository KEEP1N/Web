...
public class ModifNiveau  {
	...
	public ModifNiveau() {
		...
		btnTick.setToolTipText("Ajouter");
		btnTick.setIcon(new ImageIcon("C:\\wamp\\www\\KeepIn\\Web\\SiteKEEPIN\\image\\check-mark-8-24.png"));
		btnTick.setBounds(850, 410, 25, 25);
		modifNiveau.getContentPane().add(btnTick);
		
		JButton btnX = new JButton("");
		btnX.setToolTipText("Supprimer");
		btnX.setIcon(new ImageIcon("C:\\wamp\\www\\KeepIn\\Web\\SiteKEEPIN\\image\\x-mark-5-24.png"));
		btnX.setBounds(900, 410, 25, 25);
		modifNiveau.getContentPane().add(btnX);
